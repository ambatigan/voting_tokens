...
contract Voting {
  ...
  struct voter {
    ...
    /* We have an array of candidates initialized below.
     Every time this voter votes with his or her tokens, the value at that
     index is incremented. Example, if candidateList array declared
     below has ["Murthy", "Sridhar", "Ganga"] and this
     voter votes 10 tokens to Sridhar, the tokensUsedPerCandidate[1]
